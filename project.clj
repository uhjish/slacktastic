(defproject com.rootedinsights/slacktastic "0.0.1"
  :description
  ...
  :ring
    {:port 40000
     :init com.rootedinsights.slacktastic.service/initialize!
     :handler com.rootedinsights.slacktastic.service/main-handler
     :destroy com.rootedinsights.slacktastic.service/destroy!}
  ...
  :publish {:local-prefix "target/coverage"
            ...
            :remote-prefix "test-results/slacktastic/coverage"})
