(ns com.rootedinsights.slacktastic.listener.run
  (:require [clojure.tools.cli :refer [parse-opts]]
            [clojure.string :as string]
            [com.rootedinsights.slacktastic.listener.main :as main]))
...
(defn -main
  "Main entry function for listener, takes -t as option for
   ...
   lein run -m com.rootedinsights.slacktastic.listener.run -t 'Token here'"
  [& args]
